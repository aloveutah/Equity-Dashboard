...
HTML FILE THAT INCLUDES TITLE FOR DASHBOARD:
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Equity Team Task Dashboard</title>
    <link rel="stylesheet" href="styles.css">
    <script src="https://cdn.jsdelivr.net/npm/chart.js"></script>
    <script src="script.js" defer></script>
</head>
<body>
    <h1>Equity Team Task Dashboard</h1> <!-- Title Added Here -->
    <div class="dashboard-container">
        <div class="dashboard">
            ...
            <div class="task-rows" id="task-rows">
                <!-- Task rows will be dynamically appended here -->
            </div>
        ...
        <div class="completed-tasks">
            ...
            <div class="completed-rows" id="completed-rows">
